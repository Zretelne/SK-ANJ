...
import { User as UserIcon, ChevronDown, Layers } from 'lucide-react';
...
export const AppBar: React.FC<AppBarProps> = ({ title, onProfileClick, onCollectionClick }) => {
  const { user } = useAuth();
  const { activeCollection } = useVocab();
        ...
        >
          ...
          <div className="flex flex-col items-start">
             ...
             <div className="flex items-center space-x-1">
               <h1 className="text-sm font-bold tracking-wide font-sans text-gray-100 max-w-[150px] truncate">
